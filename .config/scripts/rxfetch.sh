...
echo -e "  ┏━━━━━━━━━━━━━━━━━━━━━━┓"
echo -e "  ┃ Hello_Ashu!${c0}  ${c5}${c0}  ${c6}${c0}  ${c7}${c0} ┃  ${codename}${c5}@${c0}${client_base}"
echo -e "  ┣━━━━━━━━━━━━━━━━━━━━━━┫"
echo -e "  ┃                      ┃  ${c1}${c0}  ${model}"
echo -e "  ┃          ${c3}•${c8}_${c3}•${c0}         ┃  ${c2}${c0}  ${os}"
echo -e "  ┃          ${c8}${c0}${c9}oo${c0}${c8}|${c0}         ┃  ${c7}${c0}  ${kernel}"
echo -e "  ┃         ${c8}/${c0}${c10} ${c0}${c8}'\'${c0}        ┃  ${c4}󰏖${c0}  ${packages}"
echo -e "  ┃        ${c9}(${c0}${c8}\_;/${c0}${c9})${c0}        ┃  ${c5}󰘳${c0}  ${shell}"
echo -e "  ┃                      ┃  ${c6}${c0} ${uptime}"
echo -e "  ┃   android ${c1}󱚥${c0} termux   ┃  ${c1}󰟜${c0}  ${memory}"
echo -e "  ┃                      ┃  ${c2}${c0}  ${storage}"
